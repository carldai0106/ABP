...
{
    public class SessionTests : AbpIntegratedTestBase<int, long>
    {
        [Fact]
        public void Should_Be_Default_On_Startup()
        {
            ...
            AbpSession.TenantId.ShouldBe(0);
        ...
        public void Can_Change_Session_Variables()
        {
            ...
            var resolvedAbpSession = LocalIocManager.Resolve<IAbpSession<int, long>>();
