...
namespace Abp.NHibernate.Repositories
{
    ...
    public class NhRepositoryBase<TEntity, TPrimaryKey, TTenantId, TUserId> : AbpRepositoryBase<TEntity, TPrimaryKey>
        ...
        where TUserId : struct
    {
        ...
        private readonly ISessionProvider<TTenantId, TUserId> _sessionProvider;
