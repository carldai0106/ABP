...
namespace Abp.Web.Mvc.Controllers
{
    ...
    /// </summary>
    public abstract class AbpController<TTenantId, TUserId> : Controller
        ...
        where TUserId : struct
    {
        ...
        /// </summary>
        public ISettingManager<TTenantId, TUserId> SettingManager { get; set; }
        ...
        private AuditInfo<TTenantId, TUserId> _auditInfo;
        ...
        private void HandleAuditingBeforeAction(ActionExecutingContext filterContext)
        {
            ...
            _auditInfo = new AuditInfo<TTenantId, TUserId>
            {
