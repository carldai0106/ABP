...
namespace Abp.EntityFramework.Repositories
{
    ...
    /// <typeparam name="TTenantId">Type of the Tenant</typeparam>
    /// <typeparam name="TUserId">Type of the User</typeparam>
    public class EfRepositoryBase<TDbContext, TEntity, TPrimaryKey, TTenantId, TUserId> : AbpRepositoryBase<TEntity, TPrimaryKey>
        ...
        where TUserId : struct
    {
        ...
        private readonly IDbContextProvider<TDbContext, TTenantId, TUserId> _dbContextProvider;
