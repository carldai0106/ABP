...
namespace Abp.Configuration
{
        ...
        where TUserId : struct
    {
        ...
        /// <returns>Current value of the setting</returns>
        Task<string> GetSettingValueForTenantAsync(string name, TTenantId tenantId);
        ...
        Task<string> GetSettingValueForUserAsync(string name, TTenantId? tenantId, TUserId userId);
        ...
        /// <returns>List of setting values</returns>
        Task<IReadOnlyList<ISettingValue>> GetAllSettingValuesForTenantAsync(TTenantId tenantId);
        ...
        Task<IReadOnlyList<ISettingValue>> GetAllSettingValuesForUserAsync(TUserId userId);
        ...
        /// <param name="name">Unique name of the setting</param>
        /// <param name="value">Value of the setting</param>
        Task ChangeSettingForTenantAsync(TTenantId tenantId, string name, string value);
        ...
        /// <param name="name">Unique name of the setting</param>
        /// <param name="value">Value of the setting</param>
        Task ChangeSettingForUserAsync(TUserId userId, string name, string value);
    }
}