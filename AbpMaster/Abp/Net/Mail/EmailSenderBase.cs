...
namespace Abp.Net.Mail
{
    ...
    /// </summary>
    public abstract class EmailSenderBase<TTenantId, TUserId> : IEmailSender<TTenantId, TUserId>
        where TTenantId : struct
        where TUserId : struct
    {
        private readonly IEmailSenderConfiguration<TTenantId, TUserId> _configuration;

        /// <summary>
        ///     Constructor.
        /// </summary>
        /// <param name="configuration">Configuration</param>
        protected EmailSenderBase(IEmailSenderConfiguration<TTenantId, TUserId> configuration)
        {
