...
namespace Abp.Authorization.Interceptors
{
    ...
    /// </summary>
    public class AuthorizationInterceptor<TTenantId, TUserId> : IInterceptor
        ...
        where TUserId : struct
    {
        ...
        {
            using (var authorizationAttributeHelper = _iocResolver.ResolveAsDisposable<IAuthorizeAttributeHelper<TTenantId, TUserId>>()) //TODO: Inject?
            {
