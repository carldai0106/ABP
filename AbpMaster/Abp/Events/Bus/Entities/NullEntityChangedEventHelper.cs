namespace Abp.Events.Bus.Entities
{
        ...
        where TUserId : struct
    {
        ...
        /// </summary>
        public static NullEntityChangedEventHelper<TTenantId, TUserId> Instance { get { return SingletonInstance; } }
        private static readonly NullEntityChangedEventHelper<TTenantId, TUserId> SingletonInstance = new NullEntityChangedEventHelper<TTenantId, TUserId>();
