    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                {
                    { "DynamicFilter_ActionEntity_MustHaveTenant", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Actions", "TenantId", "dbo.Tenants");
            ...
            DropIndex("dbo.Actions", new[] { "TenantId" });
