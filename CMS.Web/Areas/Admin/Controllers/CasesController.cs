...
namespace EPS.Web.Areas.Admin.Controllers
{
    public class CasesController : BaseController
    {
        ...
        [Permission(ActionCode = "Display", ModuleCode = "Cases")]
        ...
        [HttpGet]
        [Permission(ActionCode = "Add", ModuleCode = "Cases")]
        ...
        [HttpGet]
        [Permission(ActionCode = "Edit", ModuleCode = "Cases")]
        ...
        [Permission(ActionCode = "Delete", ModuleCode = "Cases")]
        public ActionResult Delete(string id)
        {
            ...
            return Redirect(string.Format("~/Admin/Cases/Index?MenuID={0}&page={1}", TempData["_menuid"], page));
        }
